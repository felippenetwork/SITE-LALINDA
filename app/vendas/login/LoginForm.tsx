...
// Login dedicado, separado de /auth de propósito: conta de vendedor é
// criada manualmente pelo admin (sem autocadastro, mesmo padrão de
// admin.createUser() já usado), e /auth redireciona sempre pra /admin —
// um vendedor logando lá cairia num loop, já que o gate de /admin exige
// admin/operador. Sem "criar conta" aqui — só login.
        ...
        <Card className="rounded-[2rem] md:rounded-[3rem] border-border shadow-sm overflow-hidden">
          <CardHeader className="bg-background/50 border-b border-border p-6 md:p-10 text-center">
            ...
            <CardDescription className="font-sans text-muted-foreground text-[10px] md:text-xs uppercase tracking-widest mt-2 font-bold">
              Lance pedidos em nome dos seus clientes
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6 md:p-10">
            ...
            <div className="mt-12 text-center">
              <p className="text-[10px] font-sans text-stone-300 uppercase tracking-widest font-bold leading-loose">
                Acesso exclusivo para vendedores cadastrados.
                <br />
