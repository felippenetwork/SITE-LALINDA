    ...
    <header className={cn(
      ...
      <nav className="mx-auto px-4 md:px-8 py-3 md:py-6 flex items-center justify-between">
        ...
        <div className={cn(
          ...
          isTransparent || isDark ? "bg-white/5 border-white/10" : "bg-stone-50/50 border-stone-100"
        )}>
          {menuItems.map((item) => (
            <Link 
              key={item.label}
              ...
              className={cn(
                ...
                !isTransparent && !isDark && activeItem !== item.label ? "text-stone-400 hover:text-foreground" : "",
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-stone-900 border-stone-800 text-white p-12 flex flex-col justify-center">
