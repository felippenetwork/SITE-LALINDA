        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-32">
          ...
          >
            <div className="space-y-6">
              <span className="text-primary font-serif italic text-xl md:text-3xl block">Nossa Herança</span>
              <h2 className="text-5xl md:text-[8rem] font-serif italic leading-[0.85] tracking-tighter">Alma <br/>em cada <br/>Fibras.</h2>
            </div>
            <p className="text-stone-400 font-sans leading-relaxed text-base md:text-xl max-w-md">
              Desde 1998, nossa missão é preservar a essência do pão. Assista ao documentário que revela o segredo de nossa referência em qualidade.
            </p>
            <div className="pt-4">
              <Link to="/a-lalinda" className="bg-white text-stone-900 px-10 md:px-14 py-5 md:py-7 rounded-full font-sans uppercase tracking-[0.2em] text-[9px] md:text-[10px] font-black hover:bg-primary hover:text-white transition-all shadow-xl shadow-black/10 active:scale-95">
                Nossa Jornada
              </Link>
            </div>
          </motion.div>
