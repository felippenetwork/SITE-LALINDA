...
export const Route = createFileRoute("/auth/")({
  ...
  head: () => ({
    meta: [{ title: "Acesso Administrativo | La Linda" }],
  }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-4 md:p-8 font-serif selection:bg-primary selection:text-white">
      <Link to="/" className="inline-flex items-center gap-4 text-stone-400 font-sans uppercase tracking-widest text-[8px] md:text-[10px] font-black mb-8 md:mb-12 hover:text-foreground transition-colors group">
      ...
      <div className="w-full max-w-[450px]">
        <div className="text-center mb-8 md:mb-12">
          ...
          <span className="text-[10px] font-sans font-black uppercase tracking-[0.4em] text-primary block">Acesso Reservado</span>
        </div>
        ...
        <Card className="rounded-[2rem] md:rounded-[3rem] border-stone-100 shadow-sm overflow-hidden">
          <CardHeader className="bg-stone-50/50 border-b border-stone-100 p-6 md:p-10 text-center">
            <CardTitle className="text-xl md:text-2xl italic text-stone-900">Login Administrativo</CardTitle>
            <CardDescription className="font-sans text-stone-400 text-[10px] md:text-xs uppercase tracking-widest mt-2 font-bold">Gerencie seu catálogo artesanal</CardDescription>
          </CardHeader>
          <CardContent className="p-6 md:p-10">
            <form onSubmit={handleLogin} className="space-y-6 md:space-y-8">
              <div className="space-y-3">
                <Label htmlFor="email" className="text-[10px] uppercase tracking-widest font-black text-stone-400 flex items-center gap-2">
                  <Mail size={12} /> E-mail
                </Label>
                <Input 
                  id="email" 
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <Label htmlFor="password" className="text-[10px] uppercase tracking-widest font-black text-stone-400 flex items-center gap-2">
                    <Lock size={12} /> Senha
                  </Label>
                </div>
                <Input 
